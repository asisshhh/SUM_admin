  ...
  return (
    <tr className="border-b hover:bg-slate-50 transition">
      ...
      <td className="p-3 text-center">
        <span className="px-2 py-1 bg-purple-100 text-purple-700 rounded-full text-xs font-medium flex items-center justify-center gap-1">
          <Home size={12} />
          {pkg.serviceCount || pkg.services?.length || 0} services
        </span>
      </td>
