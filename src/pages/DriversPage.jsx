              ...
              <table className="w-full">
                <thead className="bg-slate-50 border-b border-slate-200">
                  <tr>
                    ...
                    <th className="px-6 py-3 text-left text-xs font-semibold text-slate-600 uppercase">License</th>
                    <th className="px-6 py-3 text-left text-xs font-semibold text-slate-600 uppercase">Experience</th>
                    <th className="px-6 py-3 text-center text-xs font-semibold text-slate-600 uppercase">Rating</th>
                    ...
                    <tr key={item.id} className="hover:bg-slate-50">
                      <td className="px-6 py-4">
                        ...
                        {item.emergencyContact && (
                          <div className="text-xs text-slate-500">Emergency: {item.emergencyContact}</div>
                        )}
                      </td>
                      <td className="px-6 py-4">
                      ...
                      <td className="px-6 py-4">
                        <div className="text-slate-600">{item.licenseNumber}</div>
                        {item.licenseExpiry && (
                      ...
                      <td className="px-6 py-4">
                        <div className="text-slate-600">{item.experience ? `${item.experience} years` : "-"}</div>
                      </td>
  ...
  useEffect(() => {
    if (editing) {
      setFormData({
        ...
        licenseExpiry: editing.licenseExpiry ? new Date(editing.licenseExpiry).toISOString().split("T")[0] : "",
